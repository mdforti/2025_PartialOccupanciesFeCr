...
\begin{figure}
  ...
  \caption{\protect\label{fig:introduction}
    (\subref{fig:sigmaUnitCell001}) (001) and (\subref{fig:sigmaUnitCell100}) (100) views of the σ phase unit cell.
...
First, we calculate the properties of the \textsigma-phase using a sublattice model.
...
\MFnew{The compound energy formalism (CEF) considers the so-called end member formation enthalpies at 0K, for us the formation entlapies of the all the configurations of the sublattice model, to calculate the Gibbs free energy as a function of the composition and temperature. } 
\MFnew{[missing refs Dupin and Fries]}
\MFnew{The problem can be posed as an optimization of the occupancies 
  y \textsubscript{i} \textsuperscript{s} defined as the fraction of element i in the lattice site s.
} 
...
\noindent  such that the weighted Gibbs free energy is minimized at finite temperature \cite{zhang_prediction_2025}:
